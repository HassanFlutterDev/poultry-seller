...
import 'package:poultry_pal_seller/views/products_screen/add_product.dart';
import 'package:poultry_pal_seller/views/products_screen/product_details.dart';
import 'package:poultry_pal_seller/views/widget/appbar_widget.dart';
                ...
                child: Column(
                  children: List.generate(
                    ...
                    (index) => Card(
                      child: ListTile(
                        onTap: () {
                          print(data[index]['p_imgs'].toString());
                          Get.to(
